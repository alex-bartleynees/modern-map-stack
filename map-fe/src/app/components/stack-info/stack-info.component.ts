...
export class StackInfoComponent {
  entries: StackEntry[] = [
    ...
    { layer: 'Terrain (AWS)', source: 'Raster DEM', badge: 'raster' },
    { layer: 'Meshblocks', source: 'PMTiles→Martin', badge: 'pmtiles' },
    { layer: 'TA Boundaries', source: 'Martin', badge: 'martin' },
    { layer: 'Contours', source: 'PMTiles→Martin', badge: 'pmtiles' },
    { layer: 'Suburbs', source: 'PMTiles→Martin', badge: 'pmtiles' },
    { layer: 'Parcels', source: 'Martin', badge: 'martin' },
    { layer: 'Buildings (2D/3D)', source: 'PMTiles→Martin', badge: 'pmtiles' },
    { layer: 'Subject Property', source: 'GeoJSON', badge: 'geojson' },
    { layer: 'Zone Drawing', source: 'GeoJSON', badge: 'geojson' },
    { layer: 'Flood Plains', source: 'Martin', badge: 'martin' },
    { layer: 'Census SA2', source: 'Martin', badge: 'martin' },
